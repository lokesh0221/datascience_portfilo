...
export const ContactSection = () => {
  ...
  const handleSubmit = (e) => {
    ...
    window.location.href = `mailto:venkatlokesh.221@gmail.com?subject=${subject}&body=${body}`;
    toast({
      title: "Opening your email app…",
      description: "Your message is ready to send in your mail client.",
    });
  };

  return (
    <section id="contact" className="py-8 md:py-12 px-4 relative">
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          <AnimatedContent direction="horizontal" distance={80} reverse>
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div className="text-left">
                  ...
                  <a
                    href="mailto:venkatlokesh.221@gmail.com"
                    className="text-muted-foreground hover:text-primary transition-colors"
                  >
                    venkatlokesh.221@gmail.com
                  </a>
                </div>
              </div>
              <div className="flex items-start space-x-4">
            ...
            <div className="pt-8">
              ...
              <div className="flex space-x-4">
                <a
                  href="https://www.linkedin.com/in/venkatlokesh221/"
                  target="_blank"
          ...
          <AnimatedContent direction="horizontal" distance={80}>
            <SpotlightCard className="p-8 rounded-xl border border-border bg-card/60 backdrop-blur-sm">
              ...
              <form className="space-y-6" onSubmit={handleSubmit}>
                <div>
                  ...
                  <input
                    ...
                    placeholder="Nannuri Venkata Lokesh..."
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-3 rounded-md border border-input bg-background focus:outline-hidden focus:ring-2 focus:ring-primary"
                    placeholder="venkatlokesh.221@gmail.com"
                  />
                </div>
